...
def message = Mobile.getText(findTestObject('Object Repository/Login/Error Message'), 0)

Mobile.comment('Then login error message should be displayed')

Mobile.verifyEqual(message, 'Please enter a valid email address')
